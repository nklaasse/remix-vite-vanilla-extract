...
export interface BlogPostStoryblok {
  ...
  subject: StoryblokStory<BlogCategoryStoryblok> | StoryblokStory<BlogSubjectStoryblok> | string;
...
export interface TrustpilotReviewsStoryblok {
  title: string;
  _uid: string;
